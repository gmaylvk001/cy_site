  ...
  return (
    <>
      <LandingHeader />
              ...
              <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
               ...
               <div className="md:col-span-2 mt-4">
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-[#2a7b9b] via-[#57c785] to-[#eddd53] text-black py-2 rounded font-semibold hover:bg-lime-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
        ...
        {/* partner section */}
        <section id="why" className="bg-white py-10">
        ...
        <section id="testimonials" className="bg-[#2f2f2f] py-10">
          <div className="max-w-7xl mx-auto px-4">
        ...
        <section className="py-10">
          <div className="relative max-w-7xl mx-auto px-6 rounded-lg overflow-hidden">
...
function HoverCard({ image, title, description, author }) {
  return (
    <div className="relative w-[260px] h-[420px] rounded-xl border-2 border-[#9acd32] overflow-hidden group cursor-pointer transition-all duration-500 ease-in-out md:hover:w-[500px]">
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent 
                      ...
                      transition-opacity duration-300 flex flex-col justify-end p-5 md:hover:bg-[#000000ab]">
