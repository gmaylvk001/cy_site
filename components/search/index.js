                  ...
                  <div key={p._id} className="group relative bg-white rounded-lg border hover:border-blue-200 transition-all shadow-sm hover:shadow-md flex flex-col h-full">
                    ...
                    <div className="p-3 flex flex-col h-full">
                      ...
                      <div className="mt-auto flex items-center justify-between gap-2">
                        ...
                        <a href={`https://wa.me/9191919191?text=${encodeURIComponent(`Check Out This Product:${process.env.NEXT_PUBLIC_API_URL}/product/${p.slug}`)}`} target="_blank" rel="noopener noreferrer" className="bg-green-500 hover:bg-green-600 text-white p-1 rounded-full">
