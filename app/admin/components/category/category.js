  ...
  const renderCategoryTree = (categories, level = 0) => {
    return categories.map((category) => (
      <div key={category._id} className="ml-4">
        <div
          className={`p-2 cursor-pointer ${(newCategory.parentid === category._id || categoryToUpdate.parentid === category._id)
        ...
        >
          ...
          <span className={`font-semibold ${(newCategory.parentid === category._id || categoryToUpdate.parentid === category._id)
              ? "text-red-500"
              : ""
            }`}>
          ...
          <div className="flex justify-between items-center mt-6 flex-wrap gap-3">
            ...
            <div className="pagination flex items-center space-x-1">
              ...
              <button
                ...
                className={`px-3 py-1.5 border border-gray-300 rounded-md ${currentPage === pageCount - 1 || pageCount === 0
                    ? "text-gray-400 cursor-not-allowed"
                    : "text-black bg-white hover:bg-gray-100"
                  }`}
              ...
              <form onSubmit={handleAddCategory} className="space-y-5">
                ...
                <div>
                  ...
                  <div className="border border-gray-300 rounded-md max-h-40 overflow-y-auto p-2">
                    <div>
                      <div
                        className={`p-2 cursor-pointer rounded-md font-semibold ${newCategory.parentid === "none"
              ...
              {updateErrorMessage}
                ...
                <div>
                  ...
                  <div className="border border-gray-300 rounded-md max-h-40 overflow-y-auto p-2">
                    <div>
                      <div
                        className={`p-2 cursor-pointer rounded-md font-semibold ${categoryToUpdate.parentid === "none"
                            ? "bg-red-100 text-red-600"
                            : "text-gray-800 hover:bg-gray-100"
                          }`}
