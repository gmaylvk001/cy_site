...
export default function AddProductPage({
  ...
  useEffect(() => {
    if (mode === "edit" || productData) {
      ...
      // Initialize warranties from productData
      if (
        productData.extend_warranty &&
        productData.extend_warranty.length > 0
      ) {
        setWarranties(productData.extend_warranty);
      } else {
        setWarranties([{ year: "", amount: "" }]);
  ...
  const handleRemoveOverviewImage = (index) => {
    setProduct((prev) => {
      ...
      return {
        ...
        removedOverviewImages: [
          ...(prev.removedOverviewImages || []),
          removedImage,
        ],
      };
    });
        ...
        <div className="flex items-center cursor-pointer p-2 text-sm font-medium text-gray-700">
          ...
          {category.children.length == 0 && (
            <input
              ...
              name="category"
              value={category._id}
              checked={selectedCategory.has(category._id)}
  ...
  return (
    <div className="mx-auto p-6 bg-white shadow-md rounded-lg">
      ...
      <ToastContainer />
      {validationError && (
        <ValidationModal message={validationError} onClose={closeModal} />
      )}
          ...
          <div className="space-y-4">
              ...
              <div>
                ...
                {product.name.length > 0 && product.name.length < 20 && (
                  <p className="text-red-500 text-xs mt-1">
                    Minimum 20 characters required (currently:{" "}
                    {product.name.length})
                  </p>
                )}
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  name="stock_status"
                  value={product.stock_status || "Out of Stock"}
                  onChange={handleChange}
                  className="w-full border p-2 rounded"
                >
            ...
            hover:file:bg-blue-100"
                            ...
                            <td className="px-4 py-3">
                              <div className="flex gap-3">
                                ...
                                <button
                                  type="button"
                                  onClick={() =>
                                    handleRemoveOverviewImage(index)
                                  }
              ...
              <div className="flex flex-col">
                ...
                <textarea
                  ...
                  value={product.overviewdescription || ""}
                  onChange={handleChange}
                  className="w-full border p-2 pt-0 rounded"
                  rows="4"
                ></textarea>
              </div>
            </div>
              ...
              {warranties.map((warranty, index) => (
                <div key={index} className="flex space-x-2 mb-2">
                  ...
                  <input
                    ...
                    value={warranty.year || ""}
                    onChange={(e) =>
                      handleWarrantyChange(index, "year", e.target.value)
                    }
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleWarrantyChange(index, "amount", e.target.value)
                    }
                    className="w-1/2 border p-2 rounded"
                    placeholder="Amount"
                  />
        ...
        {currentStep === 4 && (
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mb-2">
                ➤ Add highlights by clicking the{" "}
                <span className="font-semibold">green + button</span>.
                <br />➤ Each highlight should be written in{" "}
                <span className="italic">key: value</span> format.
                <br />
                Example:{" "}
                <span className="text-gray-600">
                  Processor: Snapdragon 8 Gen 2
                </span>
                , <span className="text-gray-600">Battery: 5000 mAh</span>,{" "}
                <span className="text-gray-600">Display: 6.5 inch AMOLED</span>
              </p>
              ...
              <Select
                ...
                value={allproducts.filter(
                  (option) =>
                    ...
                    product.related_products.includes(option.value)
                )}
